  ...
  const handleGenerateReport = async () => {
    ...
    try {
      const res = await fetch('/api/generate-report', {
        ...
        body: JSON.stringify({ hobbies, logs })
      });
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div>
        ...
        <p className="text-xs text-season-muted mt-1">
          Monitor your progress, completion rates, and active streaks.
        </p>
      </div>
      ...
      {/* Category breakdown */}
      <div className="p-6 rounded-3xl border border-season-border bg-season-card shadow-xs mt-4">
